                ...
                using (var stream = new MemoryStream())
                {
                    if (form["listItemId"] != null && form["listItemId"] !=  "")
                    {
                        ...
                        if (listIds.Count() > 0)
                        {
                            ...
                            filename = "[VIETMY] Thống kê báo cáo lịch hẹn";
                    ...
                    else
                    {
                        ...
                        filename = "[VIETMY] Thống kê báo cáo lịch hẹn từ " + Convert.ToDateTime(form["tungay"]).ToString("dd-MM-yyyy") + " đến " + Convert.ToDateTime(form["denngay"]).ToString("dd-MM-yyyy");
