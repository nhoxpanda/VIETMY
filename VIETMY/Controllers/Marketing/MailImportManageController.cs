...
namespace VIETMY.Controllers.Marketing
{
    public class MailImportManageController : BaseController
    {
        ...
        public ActionResult ExcelSample()
        {
            try
            {
                ...
                {
                    string templateFile = System.Web.HttpContext.Current.Server.MapPath("~\\Upload\\ImportExport\\Import_EmailVIETMY.xlsx");
                    ExportExcelTemplateCustomer(stream, templateFile, header); 
                    bytes = stream.ToArray();
                }

                string fileName = "Mau-import-email-VIETMY.xlsx";
